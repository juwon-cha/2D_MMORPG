...
public class GameScene : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _map = Resources.Load<GameObject>("Prefabs/Character/Player/TestMap");
    ...
    void GenerateMapFile()
    {
        ...
        using(var writer = File.CreateText($"Assets/Resources/Prefabs/Character/Player/{_map.name}.txt"))
        {
    ...
    public void InitMap()
    {
        ...
        TextAsset txt = Resources.Load<TextAsset>("Prefabs/Character/Player/TestMap");
